   ...
   <v-subheader class="subheader black--text display-1 font-weight-bold ">DIETA</v-subheader>
    <v-form>
      <v-container>
            ...
            <material-card class="v-card-profile">
              ...
              <v-card-text class="margen text-xs-center">
                  <v-form name="formulario" method="post" enctype="form-data">
                    <v-btn class="boton" @click='pickFile' v-model='imageName' prepend-icon='attach_file'>Selecciona imagen de la dieta</v-btn>
        ...
        <v-flex xs12 sm6>
          <v-btn color="green darken-4" class="botones white--text headline" @click="save" >Agregar dieta</v-btn>
...
export default {
  ...
  methods: {
    async getDiet () {
      ...
      this.$store.commit('SET_DIET', diets)
    },
    async resetForm () {
