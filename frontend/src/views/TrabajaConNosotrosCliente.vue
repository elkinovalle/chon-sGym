...
<div class="trabaje">
  <v-container fluid>
    ...
    <v-flex xs12 sm6 md10>
        <p></p>
        <h1 class="text-xs white--text display-2 font-weight-black">TRABAJA</h1><br>
        <h1 class="text-xs white--text display-4 font-weight-black">CON NOSOTROS</h1><br>
    </v-flex>
  </v-layout>
          </v-card>
        </v-flex>
    ...
    <v-flex xs12 sm6 md12>
        <p></p>
        <h1 class="text-xs-center white--text display-2 font-italic">CONOCE <strong>LAS VACANTES</strong></h1>
        <p></p><br>
    </v-flex>
  </v-layout>
          </v-card>
 ...
 <div
  >
    ...
    >
      <v-toolbar-title class="titulo headline">Recepcionista</v-toolbar-title>
    </v-toolbar>
    <div
 ...
 <div
  >
    <v-toolbar
      ...
      scroll-target="#scrolling-techniques"
    >
      <v-toolbar-title class="titulo headline">Almacenista</v-toolbar-title>
    </v-toolbar>
    <div
      id="scrolling-techniques"
      class="scroll-y"
      ...
      <v-layout row wrap>
         ...
         <v-flex d-flex xs12 sm6 md3>
          <v-card color="transparent" dark flat>
            <v-flex d-flex xs12 sm6 md10>
          <v-card color="transparent" dark flat>
        <h1 class="text-xs white--text display-1 font-italic"><strong>HORARIOS</strong></h1>
        <br>
        <span class="text-xs white--text body-1">3 turnos: 5am-1pm.  2pm-10pm.  3pm-1pm.</span><br>
        <p></p>
