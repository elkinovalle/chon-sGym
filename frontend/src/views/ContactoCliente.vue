...
<p></p><br>
<v-btn color="blue darken-4" class="right font-weight-black white--text display-1"  to="/trabaja-con-nosotros-cliente">Trabaje con nosostros</v-btn>
          </v-card>

       </v-flex>
       <v-flex d-flex xs12 sm5 md7>
  <v-card
    class="mx-auto"
  ...
  >
    ...
    <v-toolbar
      ...
      flat
    >
      <v-card-title class="title font-weight-regular">Trabaja con Nosotros</v-card-title>
      <v-spacer></v-spacer>
    </v-toolbar>
    <v-form
      ref="form"
