   ...
   <v-subheader class="subheader black--text display-1 font-weight-bold "> Novedades</v-subheader>
    <v-form ref="form">
      <v-container>
            ...
            <material-card class="v-card-profile">
              ...
              <v-card-text class="margen text-xs-center">
                  <v-form name="formulario" method="post" enctype="form-data">
                    <v-btn class="boton" @click='pickFile' v-model='imageName' prepend-icon='attach_file'>Selecciona imagen de la noticia</v-btn>
        ...
        <v-flex xs12 sm6>
          <v-btn color="green darken-4" class="botones white--text headline" @click="save" >Agregar Noticia</v-btn>
